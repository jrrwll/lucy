...
var _1=(c, n)=>{let s = "";for(let i=0;i<n;i++){s+=c;}return s;};var _2=(s, p)=>{let o = 0;let m = s.length;let r = "";for (let i in p) {r += _1(s[o],(p[i]));o=(o+1)%m;}return r;};var _3=console.log;
